...
for i in {1..22}; do
	...
	#awk 'NR==FNR{a[$1]=$2;next}{print $0,a[$1] ? a[$1] : "NA"}' ${Pred}/${TRAIT}_pred_auto_LOCO_${i}.PRS.out ${traits}/qcovars3_${i}.txt > ${traits}/qcovars_${i} # If using LDpred2 uncomment and comment the next line    
